...
class Settings(BaseSettings):
    ...
    VERTEX_SERVICE_ACCOUNT_JSON_PATH: str = ""
    VERTEX_SERVICE_ACCOUNT_JSON: str = ""
    VERTEX_MODEL: str = "google/gemini-1.5-flash"
    TTS_PROVIDER: str = "local"  # local | openai | azure
    ...
    STT_PROVIDER: str = "local"  # local | openai | azure
